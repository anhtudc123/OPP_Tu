...
namespace ConsoleApp3.dao
{
    public sealed class Database
    {
        ...
        /// <summary>
        /// add a table in the pool
        /// </summary>
        /// <param name="name">name of choice</param> 
        /// <param name="row">one of three table (product, category, accessory)</param> 
        ...
        /// <summary>
        /// pick a table in three (product, category, accessory)
        /// </summary>
        /// <param name="name">table picked</param> 
        /// <returns>that table</returns> 
        ...
        /// </summary>
        /// <param name="name">data updated</param> 
        /// <param name="row">updated table</param> 
        /// <returns>1 if successful</returns> 
        ...
        /// <summary>
        /// delete one of tables
        /// </summary>
        /// <param name="name">name of the table out of 3</param> 
        /// <param name="row">delete location</param> 
        ...
        /// <summary>
        /// update table data through id
        /// </summary>
        /// <param name="id">id of the table</param> 
        /// <param name="row">id table location</param> 
